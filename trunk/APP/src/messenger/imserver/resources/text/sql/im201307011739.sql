...
INSERT INTO `UsersSummaryInfo` VALUES (1,'hehui','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,NULL,1,1,'0','0',3,NULL,1),(2,'admin','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,NULL,1,1,'0','0',3,NULL,1),(9,'test','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,NULL,1,1,'0','0',3,NULL,1);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`hehui`@`200.200.200.17`*/ /*!50003 PROCEDURE `sp_LogUserIn`(in p_userID varchar(16),  in p_hostAddress varchar(64), in p_hostPort smallint unsigned, out p_loginTime datetime)
BEGIN
    set p_loginTime = now();
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`hehui`@`200.200.200.17`*/ /*!50003 PROCEDURE `sp_LogUserOut`(in p_userID varchar(16),  in p_loginTime datetime)
BEGIN
...
-- Dump completed on 2013-07-01 17:38:15
