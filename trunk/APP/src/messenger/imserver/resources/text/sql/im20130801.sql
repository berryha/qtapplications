...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='成员关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `PersonalRelationship` VALUES (1,'hehui','admin',1001,NULL,'2013-08-01 20:50:24',1),(2,'hehui','test',1002,NULL,'2013-08-01 20:50:24',1);
...
INSERT INTO `UsersSummaryInfo` VALUES (1,'hehui','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,1,1,'0','0',3,NULL,1),(2,'admin','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,1,1,'0','0',3,NULL,1),(9,'test','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,0,NULL,0,0,0,1,1,'0','0',3,NULL,1);
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetAllContactsForUserAsString` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`hehui`@`200.200.200.17` PROCEDURE `sp_GetAllContactsForUserAsString`(in p_userID int(10) unsigned, in p_fieldSepartor char(5) )
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_UpdateUserContactGroupName` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`hehui`@`%` PROCEDURE `sp_UpdateUserContactGroupName`(in p_userID varchar(16), in p_groupID int(10) unsigned , in p_newGroupName varchar(32), out p_groupInfoVersion int(10) unsigned )
BEGIN
...
-- Dump completed on 2013-08-01 20:55:47
