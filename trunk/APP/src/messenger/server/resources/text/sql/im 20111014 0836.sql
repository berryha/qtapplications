...
INSERT INTO `loginhistories` (`ID`,`UserID`,`IPAddress`,`LoginTime`,`LogoutTime`) VALUES 
 (1,'admin','200.200.200.17','2011-09-28 17:48:34','2011-09-28 17:48:53'),
 (2,'admin','200.200.200.17','2011-09-29 11:52:24','2011-09-29 11:53:33'),
 (3,'admin','200.200.200.17','2011-09-29 11:55:26','2011-09-29 11:56:57');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_userlogin`(IN userID varchar(16), IN ipAddress varchar(15), IN loginTime datetime)
begin
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_userlogout`(IN userID varchar(16), IN logoutTime datetime)
begin
