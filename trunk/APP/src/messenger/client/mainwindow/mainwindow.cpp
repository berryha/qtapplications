...
void MainWindow::slotUpdateContactsInfo(){
    ...
    //ui.userHeadPortraitToolButton->setIcon(ImageResource::createIconForContact(imUser->getFace(), true));
...
void MainWindow::slotUserVerified(){
    if(ui.loginPage->getState() == LoginWidget::VERIFYING){
        ...
        ui.userHeadPortraitToolButton->setIcon(ImageResource::createIconForContact(imUser->getFace(), IM::ONLINESTATE_ONLINE));
        //ui.userHeadPortraitToolButton->setIcon(ImageResource::createMixedIcon((QString(RESOURCE_PATH)+QString(APP_ICON_PATH)), imUser->getOnlineState()));
...
void MainWindow::slotProcessUserInfo(const QString &userID, const QString &userInfo){
    if(userID == imUser->getUserID()){
        ...
        ui.userHeadPortraitToolButton->setIcon(ImageResource::createIconForContact(imUser->getFace(), imUser->getOnlineState()));
        ui.labelUserNickName->setText(imUser->getNickName());
