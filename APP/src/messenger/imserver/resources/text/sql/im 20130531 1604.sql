...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='基本信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `UsersSummaryInfo` VALUES (1,'hehui','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,NULL,0,0,0,NULL,1,1,'0','0',3,NULL,1),(2,'admin','s0jwcxN/IhFAz7GaJEk29xPToSw=',NULL,NULL,0,NULL,0,0,0,NULL,1,1,'0','0',3,NULL,1);
...
-- Dump completed on 2013-05-31 16:04:16
