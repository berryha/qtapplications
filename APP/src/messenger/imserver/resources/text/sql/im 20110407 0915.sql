...
--
-- Definition of table `cachemessages`
--

DROP TABLE IF EXISTS `cachemessages`;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='缓存的消息';

--
-- Dumping data for table `cachemessages`
--

/*!40000 ALTER TABLE `cachemessages` DISABLE KEYS */;
/*!40000 ALTER TABLE `cachemessages` ENABLE KEYS */;
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='好友请求';
...
INSERT INTO `users_detailed_info` (`ID`,`UserID`,`UserPassword`,`TrueName`,`NickName`,`Gender`,`Age`,`Face`,`PersonalContactGroupsInfo`,`PersonalContactGroupsInfoVersion`,`InterestGroupsInfo`,`InterestGroupsInfoVersion`,`BlacklistInfoVersion`,`Blacklist`,`PersonalInfoVersion`,`HomeAddress`,`HomePhoneNumber`,`HomeZipCode`,`PersonalHomepage`,`PersonalEmailAddress`,`LastLoginTime`,`LastLoginHostAddress`,`LastLoginHostPort`,`QuestionForSecurity`,`AnswerForSecurity`,`EmailForSecurity`,`CompanyName`,`JobTitle`,`BusinessAddress`,`BusinessPhoneNumber`,`BusinessZipCode`,`BusinessFaxNumber`,`BusinessHomepage`,`BusinessEmailAddress`,`RegistrationTime`,`LoginTimes`,`FriendshipApply`,`ShortTalk`,`Role`) VALUES 
 (1,'hehui','P66eKnCMcBPetxi+LMKG2P7cBSA=','贺辉','辉','1',0,'0','',1,'1',3,0,'',1,NULL,NULL,NULL,NULL,NULL,'2011-04-07 09:04:39',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0',1),
 (2,'admin','P66eKnCMcBPetxi+LMKG2P7cBSA=','Admin','Admin','1',0,'0','',1,'1',3,0,NULL,1,NULL,NULL,NULL,NULL,NULL,'2011-04-06 17:17:39',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0',2),
