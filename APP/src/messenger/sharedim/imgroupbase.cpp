...
IMGroupBase::IMGroupBase(quint32 groupID, QObject *parent)
...
bool IMGroupBase::hasMember(const QString &memberUserID){
...
quint32 IMGroupBase::memberRole(const QString &memberUserID){
...
void IMGroupBase::setGroupInfoString(const QString &infoString){
...
QString IMGroupBase::getGroupInfoString(){
...
void IMGroupBase::addMember(const QString &memberuserID, quint32 memberRole){

    membersHash.insert(memberuserID, memberRole);
}

void IMGroupBase::deleteMember(const QString &memberuserID){

    membersHash.remove(memberuserID);
}

QStringList IMGroupBase::members() const{
